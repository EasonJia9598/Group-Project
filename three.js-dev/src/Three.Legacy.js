...
Object.defineProperties( Light.prototype, {
	...
	shadowCameraVisible: {
		set: function () {
			...
			console.warn( 'THREE.Light: .shadowCameraVisible has been removed. Use new THREE.CameraHelper( light.shadow.camera2 ) instead.' );
...
Object.assign( WebGLRenderer.prototype, {
	...
	animate: function ( callback ) {
		...
		console.warn( 'THREE.WebGLRenderer: .animate2() is now .setAnimationLoop().' );
