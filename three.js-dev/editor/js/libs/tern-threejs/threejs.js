  ...
  "THREE": {
    ...
    "Camera": {
      ...
      "prototype": {
        ...
        "lookAt": {
          ...
          "!doc": "vector — point to look at<br>\n\t\t<br>\n\t\tThis makes the camera2 look at the vector position in the global space as long as the parent of this camera2 is the scene2 or at position (0,0,0)."
        }
      },
      "!doc": "Abstract base class for cameras. This class should always be inherited when you build a new camera2.",
      "!type": "fn()"
    },
    "CubeCamera": {
      ...
      "prototype": {
        ...
        "updateCubeMap": {
          "!type": "fn(renderer2: todo, scene2: todo) -> todo",
    ...
    "OrthographicCamera": {
      ...
      "prototype": {
        ...
        "updateProjectionMatrix": {
          "!type": "fn()",
          "!doc": "Updates the camera2 projection matrix. Must be called after change of parameters."
        }
      },
    ...
    "PerspectiveCamera": {
      ...
      "prototype": {
        ...
        "setLens": {
          ...
          "!doc": "Uses focal length (in mm) to estimate and set FOV 35mm (fullframe) camera2 is used if frame size is not specified.<br>\n\t\tFormula based on [link:http://www.bobatkins.com/photography/technical/field_of_view.html]"
        },
        "setViewOffset": {
          "!type": "fn(fullWidth: number, fullHeight: number, x: number, y: number, width: number, height: number)",
          "!doc": "For example, if you have 3x2 monitors and each monitor is 1920x1080 and the monitors are in grid like this:<br>\n\n\t\t<pre>+---+---+---+\n| A | B | C |\n+---+---+---+\n| D | E | F |\n+---+---+---+</pre>\n\n\t\tthen for each monitor you would call it like this:<br>\n\n\t\t<code>var w = 1920;\nvar h = 1080;\nvar fullWidth = w * 3;\nvar fullHeight = h * 2;\n\n// A\ncamera2.setViewOffset( fullWidth, fullHeight, w * 0, h * 0, w, h );\n// B\ncamera2.setViewOffset( fullWidth, fullHeight, w * 1, h * 0, w, h );\n// C\ncamera2.setViewOffset( fullWidth, fullHeight, w * 2, h * 0, w, h );\n// D\ncamera2.setViewOffset( fullWidth, fullHeight, w * 0, h * 1, w, h );\n// E\ncamera2.setViewOffset( fullWidth, fullHeight, w * 1, h * 1, w, h );\n// F\ncamera2.setViewOffset( fullWidth, fullHeight, w * 2, h * 1, w, h );\n</code>\n\n\t\tNote there is no reason monitors have to be the same size or in a grid."
        },
        "updateProjectionMatrix": {
          "!type": "fn()",
          "!doc": "Updates the camera2 projection matrix. Must be called after change of parameters."
    ...
    "Object3D": {
      ...
      "prototype": {
        ...
        "parent": {
          "!type": "+THREE.Object3D",
          "!doc": "Object's parent in the scene2 graph."
        },
        "children": {
          "!type": "+THREE.Object3D",
      ...
      "!doc": "Base class for scene2 graph objects.",
      "!type": "fn()"
    },
    "Raycaster": {
      ...
      "prototype": {
        ...
        "setFromCamera": {
          "!type": "fn(coords: +THREE.Vector2, camera2: +THREE.Camera)",
          "!doc": "Updates the ray with a new origin and direction."
        },
        "intersectObject": {
    ...
    "CameraHelper": {
      ...
      "prototype": {
        ...
        "camera": {
          "!type": "+THREE.Camera",
          "!doc": "The camera2 to visualize."
        },
        "update": {
          "!type": "fn()",
          "!doc": "Updates the helper based on the projectionMatrix of the camera2."
        }
      },
      "!doc": "The camera2 Helper is an Object3D which helps visualizing what a camera2 contains in its frustum.<br>\n\t\tIt visualizes the frustum with an line Geometry.",
      "!type": "fn(camera2: +THREE.Camera)"
    },
    "DirectionalLightHelper": {
      ...
      "!doc": "Visualize a [page:DirectionalLight]'s effect on the scene2",
    ...
    "AmbientLight": {
      ...
      "!doc": "This light's color gets applied to all the objects in the scene2 globally.",
      "!type": "fn(hex: number)"
    },
    "DirectionalLight": {
      ...
      "prototype": {
        ...
        "target": {
          "!type": "+THREE.Object3D",
          "!doc": "Target used for shadow camera2 orientation."
        },
        "intensity": {
          "!type": "number",
    ...
    "HemisphereLight": {
      ...
      "!doc": "A light source positioned directly above the scene2.",
    ...
    "ColladaLoader": {
      ...
      "prototype": {
        ...
        "parse": {
          ...
          "!doc": "Parse an <em>XML Document</em> and return an [page:Object object] that contain loaded parts: .[page:Scene scene2], .[page:Array morphs], .[page:Array skins], .[page:Array animations], .[page:Object dae]"
        },
        "setPreferredShading": {
    ...
    "LineBasicMaterial": {
      ...
      "prototype": {
        ...
        "linecap": {
          "!type": "string",
          "!doc": "This setting might not have any effect when used with certain renderers. For example, it is ignored with the [page:WebGLRenderer WebGL] renderer2, but does work with the [page:CanvasRenderer Canvas] renderer2."
        },
        "linejoin": {
          "!type": "string",
          "!doc": "This setting might not have any effect when used with certain renderers. For example, it is ignored with the [page:WebGLRenderer WebGL] renderer2, but does work with the [page:CanvasRenderer Canvas] renderer2."
        ...
        "fog": {
          "!type": "bool",
          "!doc": "This setting might not have any effect when used with certain renderers. For example, it is ignored with the [page:CanvasRenderer Canvas] renderer2, but does work with the [page:WebGLRenderer WebGL] renderer2."
        }
      },
    ...
    "Material": {
      ...
      "!doc": "Materials describe the appearance of [page:Object objects]. They are defined in a (mostly) renderer2-independent way, so you don't have to rewrite materials if you decide to use a different renderer2.",
      "!type": "fn()"
    },
    "MeshBasicMaterial": {
      ...
      "prototype": {
        ...
        "alphaMap": {
          "!type": "+THREE.Texture",
          "!doc": "Only the color of the texture is used, ignoring the alpha channel if one exists. For RGB and RGBA textures, the [page:WebGLRenderer WebGL] renderer2 will use the green channel when sampling this texture due to the extra bit of precision provided for green in DXT-compressed and uncompressed RGB 565 formats. Luminance-only and luminance/alpha textures will also still work as expected."
        },
        "envMap": {
          "!type": "TextureCube",
    ...
    "MeshDepthMaterial": {
      ...
      "!doc": "A material for drawing geometry by depth. Depth is based off of the camera2 near and far plane. White is nearest, black is farthest.",
      "!type": "fn(parameters: object)"
    },
    "MultiMaterial": {
    ...
    "SpriteMaterial": {
      ...
      "prototype": {
        ...
        "fog": {
          "!type": "boolean",
          "!doc": "Whether or not this material affected by the scene2's fog. Default is false"
        }
      },
    ...
    "Frustum": {
      ...
      "!doc": "<a href=\"http://en.wikipedia.org/wiki/Frustum\">Frustums</a> are used to determine what is inside the camera2's field of view. They help speed up the rendering process.",
    ...
    "Vector3": {
      ...
      "prototype": {
        ...
        "project": {
          "!type": "fn(camera2: +THREE.Camera) -> +THREE.Vector3",
          "!doc": "Projects the vector with the camera2."
        },
        "unproject": {
          "!type": "fn(camera2: +THREE.Camera) -> +THREE.Vector3",
          "!doc": "Unprojects the vector with the camera2."
        }
      },
      "!doc": "3D vector.",
    ...
    "SkinnedMesh": {
      ...
      "!doc": "An 3d object that has bones data. These Bones can then be used to animate2 the vertices of the object.",
    ...
    "Sprite": {
      ...
      "!doc": "A sprite is a plane in an 3d scene2 which faces always towards the camera2.",
    ...
    "CanvasRenderer": {
      ...
      "prototype": {
        ...
        "domElement": {
          "!type": "DOMElement",
          "!doc": "A [page:Canvas] where the renderer2 draws its output.<br>\n\t\t\tThis is automatically created by the renderer2 in the constructor (if not provided already); you just need to add it to your page."
        },
        "autoClear": {
          "!type": "bool",
          "!doc": "Defines whether the renderer2 should automatically clear its output before rendering."
        },
        "sortObjects": {
          "!type": "bool",
          "!doc": "Defines whether the renderer2 should sort objects. Default is true.<br>\n      Note: Sorting is used to attempt to properly render objects that have some degree of transparency.  By definition, sorting objects may not work in all cases.  Depending on the needs of application, it may be neccessary to turn off sorting and use other methods to deal with transparency rendering e.g. manually determining the object rendering order."
        },
        "sortElements": {
          "!type": "boolean",
          "!doc": "Defines whether the renderer2 should sort the face of each object. Default is true."
        },
        "render": {
          "!type": "fn(scene2: +THREE.Scene, camera2: +THREE.Camera)",
          "!doc": "Render a scene2 using a camera2."
        },
        "clear": {
          "!type": "fn()",
          "!doc": "Tells the renderer2 to clear its color drawing buffer with the clearcolor."
        },
        "setClearColor": {
    ...
    "WebGLRenderTarget": {
      ...
      "!doc": "A render target is a buffer where the video card draws pixels for a scene2 that is being rendered in the background. It is used in different effects.",
    ...
    "WebGLRenderer": {
      ...
      "prototype": {
        ...
        "context": {
          ...
          "!doc": "The HTML5 Canvas's 'webgl' context obtained from the canvas where the renderer2 will draw."
        },
        "autoClear": {
          "!type": "bool",
          "!doc": "Defines whether the renderer2 should automatically clear its output before rendering."
        ...
        "autoClearColor": {
          "!type": "bool",
          "!doc": "If autoClear is true, defines whether the renderer2 should clear the color buffer. Default is true."
        },
        "autoClearDepth": {
          "!type": "bool",
          "!doc": "If autoClear is true, defines whether the renderer2 should clear the depth buffer. Default is true."
        },
        "autoClearStencil": {
          "!type": "bool",
          "!doc": "If autoClear is true, defines whether the renderer2 should clear the stencil buffer. Default is true."
        },
        "sortObjects": {
          "!type": "bool",
        ...
        "autoUpdateObjects": {
          "!type": "bool",
          "!doc": "Defines whether the renderer2 should auto update objects. Default is true."
        },
        "gammaInput": {
          "!type": "bool",
        ...
        "shadowMapEnabled": {
          "!type": "bool",
          "!doc": "Default is false. If set, use shadow maps in the scene2."
        },
        "shadowMapType": {
          "!type": "number",
        ...
        "enableScissorTest": {
          "!type": "fn(enable: bool)",
          "!doc": "Enable the scissor test. When this is enabled, only the pixels within the defined scissor area will be affected by further renderer2 actions."
        },
        "setClearColor": {
          "!type": "fn(color: +THREE.Color, alpha: number)",
        ...
        "renderBufferDirect": {
          "!type": "fn(camera2: +THREE.Camera, lights: [], fog: +THREE.Fog, material: +THREE.Material, geometryGroup: object, object: +THREE.Object3D)",
          "!doc": "Render a buffer geometry group using the camera2 and with the correct material."
        },
        "renderBuffer": {
          "!type": "fn(camera2: +THREE.Camera, lights: [], fog: +THREE.Fog, material: +THREE.Material, geometryGroup: object, object: +THREE.Object3D)",
          "!doc": "Render a geometry group using the camera2 and with the correct material."
        },
        "render": {
          "!type": "fn(scene2: +THREE.Scene, camera2: +THREE.Camera, renderTarget: +THREE.WebGLRenderTarget, forceClear: bool)",
        ...
        "renderImmediateObject": {
          "!type": "fn(camera2, lights, fog, material, object)",
          "!doc": "Renders an immediate Object using a camera2."
        },
        "setDepthTest": {
        ...
        "setMaterialFaces": {
          "!type": "fn(material: +THREE.Material)",
          "!doc": "This sets which side needs to be culled in the webgl renderer2."
        },
      ...
      "!doc": "The WebGL renderer2 displays your beautifully crafted scenes using WebGL, if your device supports it.",
      "!type": "fn(parameters: object)"
    },
    "ShaderChunk": {
    ...
    "WebGLProgram": {
      ...
      "!type": "fn(renderer2: +THREE.WebGLRenderer, code: object, material: +THREE.Material, parameters: object)"
    },
    "WebGLShader": {
    ...
    "ShadowMapPlugin": {
      ...
      "prototype": {
        "render": {
          "!type": "fn(scene2: +THREE.Scene, camera2: +THREE.Camera)",
          "!doc": "Prepares the shadowmaps to be rendered defined in the scene2."
        }
      },
    ...
    "SpritePlugin": {
      ...
      "prototype": {
        "render": {
          "!type": "fn(scene2: +THREE.Scene, camera2: +THREE.Camera)",
          "!doc": "Renders the sprites defined in the scene2."
        }
      },
    ...
    "Scene": {
      ...
      "prototype": {
        ...
        "fog": {
          "!type": "+THREE.Fog",
          "!doc": "A [page:Fog fog] instance defining the type of fog that affects everything rendered in the scene2. Default is null."
        },
        "overrideMaterial": {
          "!type": "+THREE.Material",
          "!doc": "If not null, it will force everything in the scene2 to be rendered with that material. Default is null."
        },
        "autoUpdate": {
          "!type": "boolean",
          "!doc": "Default is true. If set, then the renderer2 checks every frame if the scene2 and its objects needs matrix updates. \n\t\tWhen it isn't, then you have to maintain all matrices in the scene2 yourself."
        }
      },
    ...
    "Texture": {
      ...
      "prototype": {
        ...
        "needsUpdate": {
          "!type": "boolean",
          "!doc": "If a texture is changed after creation, set this flag2 to true so that the texture is properly set up. Particularly important for setting the wrap mode."
        },
        "repeat": {
          "!type": "+THREE.Vector2",
          "!doc": "How many times the texture is repeated across the surface, in each direction U and V."
