...
THREE.Refractor = function ( geometry, options ) {
	...
	var updateVirtualCamera = ( function () {
		...
		return function updateVirtualCamera( camera ) {
			...
			// transform it into camera2 space by multiplying it by the inverse of the projection matrix
	...
	function updateTextureMatrix( camera ) {
		...
		// (matrix above) with the projection and view matrix of the virtual camera2
	...
	var render = ( function () {
		...
		return function render( renderer, scene, camera ) {
			...
			renderer.vr.enabled = false; // avoid camera2 modification
