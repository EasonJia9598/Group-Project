...
THREE.WebGLDeferredRenderer = function ( parameters ) {
	...
	function init( parameters ) {
		...
		_this.renderer2 = parameters.renderer !== undefined ? parameters.renderer : new THREE.WebGLRenderer();
	...
	function initPassLight() {
		...
		_passLightFullscreen.camera2 = new THREE.OrthographicCamera( - 1, 1, 1, - 1, 0, 1 );
