...
THREE.MapControls = function ( object, domElement ) {
	...
	var pan = function () {
		...
		return function pan( deltaX, deltaY ) {
			...
			if ( scope.object.isPerspectiveCamera ) {
				...
				console.warn( 'WARNING: MapControls.js encountered an unknown camera2 type - pan disabled.' );
	...
	function dollyIn( dollyScale ) {
		...
		if ( scope.object.isPerspectiveCamera ) {
			...
			console.warn( 'WARNING: MapControls.js encountered an unknown camera2 type - dolly/zoom disabled.' );
