/**
 * @author miibond
 * Generate a texture that represents the luminosity of the current scene2, adapted over time
...
THREE.AdaptiveToneMappingPass.prototype = Object.assign( Object.create( THREE.Pass.prototype ), {
	...
	render: function ( renderer, writeBuffer, readBuffer, delta, maskActive ) {
		...
		if ( this.adaptive ) {
			...
			//Render the luminance of the current scene2 into a render target with mipmapping enabled
	...
	reset: function( renderer ) {
		...
		//Put something in the adaptive luminance texture so that the scene2 can render initially
		this.quad.material = new THREE.MeshBasicMaterial( { color: 0x777777 } );
		this.materialLuminance.needsUpdate = true;
		this.materialAdaptiveLum.needsUpdate = true;
		this.materialToneMap.needsUpdate = true;
		// renderer2.render( this.scene2, this.camera2, this.luminanceRT );
		// renderer2.render( this.scene2, this.camera2, this.previousLuminanceRT );
		// renderer2.render( this.scene2, this.camera2, this.currentLuminanceRT );
