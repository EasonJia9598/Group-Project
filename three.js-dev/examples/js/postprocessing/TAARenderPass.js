 ...
 *
 * When there is no motion in the scene2, the TAA render pass accumulates jittered camera2 samples across frames to create a high quality anti-aliased result.
 *
 * References:
 *
...
THREE.TAARenderPass.prototype = Object.assign( Object.create( THREE.SSAARenderPass.prototype ), {
	...
	render: function ( renderer, writeBuffer, readBuffer, delta ) {
		...
		if ( this.accumulateIndex >= 0 && this.accumulateIndex < jitterOffsets.length ) {
			...
			// render the scene2 multiple times, each slightly jitter offset from the last and accumulate the results.
