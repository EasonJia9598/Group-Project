 ...
 * new THREE.OutlineEffect( renderer2, {
 * 	defaultThickness: 0.01,
 * 	defaultColor: [ 0, 0, 0 ],
 * 	defaultAlpha: 0.8,
 * 	defaultKeepAlive: true // keeps outline material in cache even if material is removed from scene2
 * } );
 *
...
THREE.OutlineEffect = function ( renderer, parameters ) {
	 ...
	 *
	 * effect = new THREE.StereoEffect( new THREE.OutlineEffect( renderer2 ) );
	 *
	 * function render () {
	 *
