	...
	for ( var i = 0; i < sea.actions.length; i ++ ) {
		...
		switch ( act.kind ) {
			...
			case SEA3D.Actions.CAMERA:
				...
				this.domain.camera2 = this.camera = act.camera.tag;
...
THREE.SEA3D.prototype.clone = function ( config, onParseComplete, onParseProgress ) {
	...
	this.config.container2 = config && config.container !== undefined ? config.container : new THREE.Object3D();
